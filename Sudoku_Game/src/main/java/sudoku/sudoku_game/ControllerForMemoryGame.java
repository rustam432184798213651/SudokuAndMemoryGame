...
public class ControllerForMemoryGame implements Initializable {
    // For memory game
    ArrayList<String> possibleButtons = new ArrayList<>(Arrays.asList("button0", "button1", "button2", "button3", "button4", "button5", "button6", "button7", "button8"));
